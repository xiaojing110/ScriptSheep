...
async function _0x465781() {
    ...
    if ($.farmInfo.toFlowTimes > $.farmInfo.farmUserPro.treeEnergy / 10) {
        _0x573b56 += "【开花进度】再浇水" + ($.farmInfo.toFlowTimes - $.farmInfo.farmUserPro.treeEnergy / 10) + "次开花\n";
    } else {
        $.farmInfo.toFruitTimes > $.farmInfo.farmUserPro.treeEnergy / 10 && (_0x573b56 += "【结果进度】再浇水" + ($.farmInfo.toFruitTimes - $.farmInfo.farmUserPro.treeEnergy / 10) + "次结果\n");
    }
...
async function _0x2c4bbe() {
    ...
    if (_0x38f6e5 >= 100 && _0x12fb53 > 0 && $.farmInfo.farmUserPro.treeState == 1) {
        for (let _0x17a38d = 0; _0x17a38d < new Array(_0x12fb53).fill("").length; _0x17a38d++) {
    ...
    if (jdFruitBeanCard == "true" && JSON.stringify($.myCardInfoRes).match("限时翻倍")) {
        ...
        if (_0x38f6e5 >= 100 && $.myCardInfoRes.beanCard > 0) {
            ...
            console.log("您目前水滴:" + _0x38f6e5 + "g,水滴换豆卡" + $.myCardInfoRes.beanCard + "张,暂不满足水滴换豆的条件,为您继续浇水");
        }
    }
}
...
async function _0x2df135() {
    ...
    if (_0x51dd36 >= $.farmInfo.farmUserPro.treeTotalEnergy - $.farmInfo.farmUserPro.treeEnergy) {
        ...
        if (_0x1552f9 >= 10) {
            ...
            console.log("目前剩余水滴：【" + _0x51dd36 + "】g,不再继续浇水,保留部分水滴用于完成第二天【十次浇水得水滴】任务");
        }
    }
}
    ...
    return new Promise(async _0x41d10b => {
        if ($.waterResult.waterStatus === 0 && $.waterResult.treeEnergy === 10) {
            ...
            if ($.waterResult.waterStatus === 1) {
                ...
                $.waterResult.waterStatus === 2 && (console.log("果树长出小果子啦, 奖励50g💧"), await _0x345a1d("3"), console.log("浇水阶段奖励3领取结果 " + JSON.stringify($.gotStageAwardForFarmRes)), $.gotStageAwardForFarmRes.code === "0" && console.log("【果树结果了】奖励" + $.gotStageAwardForFarmRes.addEnergy + "g💧\n"));
            }
        }
...
async function _0x5c8e64() {
    ...
    if ($.initForTurntableFarmRes.code === "0") {
        ...
        if (_0x119076.length > 0) {
            for (let _0x1e54ed = 0; _0x1e54ed < _0x119076.length; _0x1e54ed++) {
                    ...
                    _0x50a734.map(_0x3f1b63 => {
                        if (_0x3f1b63.type === $.lotteryRes.type) {
                            if ($.lotteryRes.type.match(/bean/g) && $.lotteryRes.type.match(/bean/g)[0] === "bean") {
                                _0x4bd247 += _0x3f1b63.name + "个🥔，";
                            } else {
                                $.lotteryRes.type.match(/water/g) && $.lotteryRes.type.match(/water/g)[0] === "water" ? _0x4bd247 += _0x3f1b63.name + "💧，" : _0x4bd247 += _0x3f1b63.name + "，";
                            }
                        }
                    });
    ...
    if ($.farmAssistResult.code === "0") {
        if ($.farmAssistResult.assistFriendList && $.farmAssistResult.assistFriendList.length >= 2) {
            if ($.farmAssistResult.status === 2) {
                ...
                $.farmAssistResult.status === 3 && (console.log("已经领取过8好友助力额外奖励"), _0x573b56 += "【额外奖励】已被领取过\n");
            }
        } else {
...
async function _0x385022() {
    ...
    if ($.clockInInit.code === "0") {
        ...
        if ($.clockInInit.themes && $.clockInInit.themes.length > 0) {
            for (let _0x413abe of $.clockInInit.themes) {
        ...
        if ($.clockInInit.venderCoupons && $.clockInInit.venderCoupons.length > 0) {
            for (let _0x96a34e of $.clockInInit.venderCoupons) {
...
async function _0x2380f2() {
    ...
    if (_0x4cc59e < _0x4b911a) {
                        ...
                        if ($.waterFriendForFarmRes.cardInfo.type === "beanCard") {
                            ...
                            if ($.waterFriendForFarmRes.cardInfo.type === "fastCard") {
                                ...
                                if ($.waterFriendForFarmRes.cardInfo.type === "doubleCard") {
                                    ...
                                    $.waterFriendForFarmRes.cardInfo.type === "signCard" && (console.log("获取道具卡:" + $.waterFriendForFarmRes.cardInfo.rule), _0x675421 += "加签卡,");
                                }
                            }
                        }
                    }
        ...
        console.log("今日已为" + _0x4b911a + "个好友浇水\n");
    }
}
...
async function _0x5e20fd(_0x52cc22, _0x25a921) {
    ...
    $.browserForTurntableFarmRes = await _0x47c87d("browserForTurntableFarm", _0x4053ca);
}
...
async function _0x23dc69(_0x3e1ce1) {
    ...
    $.browserForTurntableFarm2Res = await _0x47c87d("browserForTurntableFarm", _0x485895);
}
...
async function _0xc27be6() {
    ...
    $.waterRain = await _0x47c87d("waterRainForFarm", _0x200f7b);
}
...
async function _0x2a22e9(_0x92e8d, _0xa14cbb, _0x4abf3a) {
    ...
    if (_0xa14cbb === "theme") {
        if (_0x4abf3a === "1") {
            $.themeStep1 = await _0x47c87d(_0x20e3c0, _0x1bff18);
        } else {
            _0x4abf3a === "2" && ($.themeStep2 = await _0x47c87d(_0x20e3c0, _0x1bff18));
        }
    } else {
        if (_0xa14cbb === "venderCoupon") {
            if (_0x4abf3a === "1") {
                $.venderCouponStep1 = await _0x47c87d(_0x20e3c0, _0x1bff18);
            } else {
                _0x4abf3a === "2" && ($.venderCouponStep2 = await _0x47c87d(_0x20e3c0, _0x1bff18));
            }
        }
    }
}
...
async function _0x3d291f(_0x1a9f80) {
    ...
    $.waterFriendForFarmRes = await _0x47c87d("waterFriendForFarm", _0xceb8c);
}
...
function _0x4030d8() {
    return new Promise(_0x1c8e37 => {
        ...
        if ($.isNode()) {
            ...
            _0x25d9ff = [$.getdata("CookieJD"), $.getdata("CookieJD2"), ..._0x91d85e($.getdata("CookiesJD") || "[]").map(_0xc4ec57 => _0xc4ec57.cookie)].filter(_0x2d0b8e => !!_0x2d0b8e);
        }
...
function _0x4d42b6() {
    return new Promise(_0x4185db => {
        ...
        $.get(_0x39b638, (_0x130680, _0x4417c2, _0x500407) => {
            _0x4185db();
        });
    });
}
...
function _0xb6bc18() {
    return new Promise(_0x102e44 => {
        ...
        $.get(_0x3f26ae, (_0x249592, _0x3bed4d, _0x302c84) => {
            try {
                if (_0x302c84) {
                    _0x302c84 = JSON.parse(_0x302c84);

                    if (!(_0x302c84.islogin === "1")) {
                        _0x302c84.islogin === "0" && ($.isLogin = false);
                    }
                }
            } catch (_0x165135) {
...
async function _0x47c87d(_0x268fdb, _0xa4ede2 = {}, _0xaa8723 = 1500) {
    ...
    if (_0x4be267[_0x268fdb]) {
        let _0x5a1fb7 = {
            "appId": _0x4be267[_0x268fdb],
            "fn": _0x268fdb,
            "body": _0xa4ede2,
            "apid": "signed_wh5",
            "ver": $.UA.split(";")[2],
        ...
        _0xa4ede2 = "functionId=" + _0x268fdb + "&body=" + encodeURIComponent(JSON.stringify(_0xa4ede2)) + "&appid=wh5";
    }
...
function _0x401a53(_0xc4851) {
    try {
        if (typeof JSON.parse(_0xc4851) == "object") {
            return true;
        }
    } catch (_0x4855df) {
