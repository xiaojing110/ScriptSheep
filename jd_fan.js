...
let activityList = [
    ...
    {'id':'5a15eb60f4bf4298afdd5277ed31a04d','endTime':1647273599000},//2022-02-28---2022-03-14 MARSHALL影音京东自营旗舰店
    {'id':'e610a59417f44a6d9002fb9e29c08643','endTime':1648742399000},//2022-03-01---2022-03-31 戴·可·思官方旗舰店
    {'id':'86d434ce5fac43afb06fd6a920cff146','endTime':1646755200000},//2022-03-01---2022-03-15 微软京东自营官方旗舰店
    {'id':'52b9321bf03a4e1ca49f4b992cb77c88','endTime':1648742399000},//2022-03-01---2022-03-31 郎牌特曲官方旗舰店
    {'id':'2549aa36b7db4e53b2c75fa7212535e9','endTime':1648742399000},//2022-03-01---2022-03-31 
];
!(async () => {
...
async function invite(_0x8baf4c, _0x3fd6b4) {
	...
	var _0x5156ef = {
		...
		'user-agent': $.isNode() ? process.env.JS_USER_AGENT ? process.env.JS_USER_AGENT : require('./JS_USER_AGENTS')
			.USER_AGENT : $.getdata('JSUA') ? $.getdata('JSUA') : '\'jdltapp;iPad;3.1.0;14.4;network/wifi;Mozilla/5.0 (iPad; CPU OS 14_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1',
...
async function invite2(_0x36e51c, _0x97b630) {
	...
	let _0x24b1af = {
		...
		'user-agent': $.isNode() ? process.env.JS_USER_AGENT ? process.env.JS_USER_AGENT : require('./JS_USER_AGENTS')
			.USER_AGENT : $.getdata('JSUA') ? $.getdata('JSUA') : '\'jdltapp;iPad;3.1.0;14.4;network/wifi;Mozilla/5.0 (iPad; CPU OS 14_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1',
		'referer': 'https://assignment.jd.com/?inviterId=' + encodeURIComponent(_0x97b630),
		'Cookie': _0x36e51c
	};
...
function invite4(_0x4ce7d3, _0x13691e) {
	let _0x67f7ab = {
		...
		'body': 'functionId=TaskInviteService&body=' + JSON.stringify({
			...
			'data': {
				'channel': '1',
				'encryptionInviterPin': encodeURIComponent(_0x13691e),
				'type': 1
			}
...
async function runMain(_0x40ebb9) {
	_0x40ebb9.UA = _0x40ebb9.isNode() ? process.env.JD_USER_AGENT ? process.env.JD_USER_AGENT : require('./USER_AGENTS')
		.USER_AGENT : _0x40ebb9.getdata('JDUA') ? _0x40ebb9.getdata('JDUA') : 'jdapp;iPhone;9.4.4;14.3;network/4g;Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1', _0x40ebb9.token = '';
...
async function doTask(_0x23c295) {
	...
	if (_0x23c295.activityData.task3AddCart) {
		if (_0x23c295.activityData.task3AddCart.finishedCount !== _0x23c295.activityData.task3AddCart.upLimit) {
			...
			_0x23c295.upFlag = true;
			for (let _0x2527f5 = 0;
				(_0x2527f5 < _0x23c295.activityData.task3AddCart.taskGoodList.length) && (_0x90a7c2 > 0); _0x2527f5++) {
	...
	if (_0x23c295.activityData.task6GetCoupon) {
		if (_0x23c295.activityData.task6GetCoupon.finishedCount !== _0x23c295.activityData.task6GetCoupon.upLimit) {
			...
			_0x23c295.upFlag = true;
			for (let _0x48cbc6 = 0;
				(_0x48cbc6 < _0x23c295.activityData.task6GetCoupon.taskCouponInfoList.length) && (_0x90a7c2 > 0); _0x48cbc6++) {
...
async function getHtml(_0x4addca) {
	let _0x25eb03 = {
		'url': _0x4addca.thisActivityUrl,
		'headers': {
			'Host': _0x4addca.host,
			'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8',
			'Cookie': 'IsvToken=' + _0x4addca.token + ';' + _0x4addca.cookie,
			'User-Agent': _0x4addca.UA,
			'Accept-Language': 'zh-cn',
			'Accept-Encoding': 'gzip, deflate, br',
...
async function takePostRequest(_0x22084a, _0x4d19d2, _0x4cee5b = 'activityId=' + _0x22084a.activityId + '&pin=' + encodeURIComponent(_0x22084a.pin)) {
	...
	const _0x2993f8 = {
		...
		'Accept-Encoding': 'gzip, deflate, br',
		'Content-Type': 'application/x-www-form-urlencoded',
		'Origin': 'https://' + _0x22084a.host,
		'User-Agent': _0x22084a.UA,
		'Cookie': _0x22084a.cookie + ' LZ_TOKEN_KEY=' + _0x22084a.LZ_TOKEN_KEY + '; LZ_TOKEN_VALUE=' + _0x22084a.LZ_TOKEN_VALUE + '; AUTH_C_USER=' + _0x22084a.pin + '; ' + _0x22084a.lz_jdpin_token,
		'Host': _0x22084a.host,
		'Referer': _0x22084a.thisActivityUrl,
		'Accept-Language': 'zh-cn',
...
async function join(_0x20b776) {
	...
	let _0x317371 = {
		'url': 'https://api.m.jd.com/client.action?appid=jd_shop_member&functionId=bindWithVender&body={"venderId":"' + _0x20b776.venderId + '","shopId":"' + _0x20b776.venderId + '","bindByVerifyCodeFlag":1,"registerExtend":{},"writeChildFlag":0' + _0x2c5d06 + ',"channel":401}&client=H5&clientVersion=9.2.0&uuid=88888',
		'headers': {
			'Content-Type': 'text/plain; Charset=UTF-8',
			'Origin': 'https://api.m.jd.com',
			'Host': 'api.m.jd.com',
			'accept': '*/*',
			'User-Agent': _0x20b776.UA,
			'content-type': 'application/x-www-form-urlencoded',
			'Referer': 'https://shopmember.m.jd.com/shopcard/?venderId=' + _0x20b776.venderId + '&shopId=' + _0x20b776.venderId,
			'Cookie': _0x20b776.cookie
		}
	};
...
async function getshopactivityId(_0x42e0bc) {
	let _0x29a492 = {
		'url': 'https://api.m.jd.com/client.action?appid=jd_shop_member&functionId=getShopOpenCardInfo&body=%7B%22venderId%22%3A%22' + _0x42e0bc.venderId + '%22%2C%22channel%22%3A401%7D&client=H5&clientVersion=9.2.0&uuid=88888',
		'headers': {
			'Content-Type': 'text/plain; Charset=UTF-8',
			'Origin': 'https://api.m.jd.com',
			'Host': 'api.m.jd.com',
			'accept': '*/*',
			'User-Agent': _0x42e0bc.UA,
			'content-type': 'application/x-www-form-urlencoded',
			'Referer': 'https://shopmember.m.jd.com/shopcard/?venderId=' + _0x42e0bc.venderId + '&shopId=' + _0x42e0bc.venderId,
			'Cookie': _0x42e0bc.cookie
		}
	};
...
function getRandomArrayElements(_0x424ad7, _0x39bfd1) {
	var _0x4063b6 = _0x424ad7.slice(0),
		_0x57a8d = _0x424ad7.length,
		_0x5dc753 = _0x57a8d - _0x39bfd1,
		_0x3010ad, _0x581bb0;
