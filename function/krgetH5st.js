...
class iIiiii {
    ...
    async ["_signWaap"](iIIlli, ll1li1, iIIlll) {
        ...
        return (!I1iii1?.["h5st"] || I1iii1.h5st === "null") && (console.log("❌ getH5st 签名生成失败"), I1iii1.h5st = ""), I1iii1?.["h5st"] || "";
    }
    ...
    async ["getH5st"](llli1l) {
        ...
        try {
            if (!(typeof llli1l === "object" && llli1l !== null)) return console.log("❌ getH5st 传入参数有误"), llli1i; else {
                const lIilii = ["appId", "appid", "body", "client", "clientVersion", "functionId"],
                    lIilil = lIilii.filter(lIl1ll => !llli1l[lIl1ll]);

                if (lIilil.length > 0) {
                    return console.log("❌ getH5st 传入参数有误，缺少必要参数：" + lIilil.join(", ")), llli1i;
                }
            }
            ...
            return llli1i.h5st = lIl1li || "", llli1i.params += lIl1li || "", llli1i;
        } catch (l111l) {
    ...
    ["_SHA256"](Ii1II1) {
        ...
        function i1Iii1(I1lI1l, i11ii) {
            ...
            for (var IIiill = 0; IIiill < I1lI1l.length; IIiill += 16) {
                ...
                for (var liIIii = 0; liIIii < 64; liIIii++) {
                    if (liIIii < 16) lIiIl[liIIii] = I1lI1l[liIIii + IIiill]; else lIiIl[liIIii] = IllliI(IllliI(IllliI(liI1II(lIiIl[liIIii - 2]), lIiIl[liIIii - 7]), lI1I1i(lIiIl[liIIii - 15])), lIiIl[liIIii - 16]);
        ...
        function I1Ili1(IIiilI) {
            ...
            for (var liiiI1 = 0; liiiI1 < IIiilI.length; liiiI1++) {
                ...
                if (iIl11 < 128) ilIIlI += String.fromCharCode(iIl11); else iIl11 > 127 && iIl11 < 2048 ? (ilIIlI += String.fromCharCode(iIl11 >> 6 | 192), ilIIlI += String.fromCharCode(iIl11 & 63 | 128)) : (ilIIlI += String.fromCharCode(iIl11 >> 12 | 224), ilIIlI += String.fromCharCode(iIl11 >> 6 & 63 | 128), ilIIlI += String.fromCharCode(iIl11 & 63 | 128));
            }
        ...
        return Ii1II1 = I1Ili1(Ii1II1), l1liil(i1Iii1(l1liii(Ii1II1), Ii1II1.length * IliIli));
    }
