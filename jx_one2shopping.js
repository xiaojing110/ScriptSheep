...
var _0x4c8761 = function () {
    return function (_0x199b93, _0xd6ebf7) {
      var _0x222d38 = function () {
        if (_0xd6ebf7) {
          var _0x329a0f = _0xd6ebf7.apply(_0x199b93, arguments);
  ...
  var _0x365447 = _0x4c8761(this, function () {
    var _0x349e29 = function () {
      return 'dev';
    },
        _0x25fece = function () {
      return 'window';
    ...
    var _0x50964c = function () {
      var _0x5b4ea8 = new RegExp('\\w+ *\\(\\) *{\\w+ *[\'|"].+[\'|"];? *}');
  
      return !_0x5b4ea8.test(_0x349e29.toString());
    };
  
    var _0x45ce70 = function () {
      var _0x2ac4d2 = new RegExp('(\\\\[x|u](\\w){2,4})+');
  
      return _0x2ac4d2.test(_0x25fece.toString());
    };
  
    var _0x3ee646 = function (_0x4986f9) {
      if (_0x4986f9.indexOf(false)) {
        _0x2c03ed(_0x4986f9);
      }
    };
  
    var _0x2c03ed = function (_0x5a8c92) {
      if (_0x5a8c92.indexOf('e') !== 3) {
        _0x3ee646(_0x5a8c92);
      }
    };
  ...
  function _0x59c718() {
    ...
    let _0x38ff6c = '0123456789',
        _0x4c7f3f = Math.random() * 0xa | 0x0;
    ...
    do {
      _0x29e3d8 = _0x296a2f({
        'size': 0x1,
        'num': '0123456789'
      }), _0x2e7d55.indexOf(_0x29e3d8) == -0x1 && (_0x2e7d55 += _0x29e3d8);
    } while (_0x2e7d55.length < 0x3);
  
    for (let _0x5d726a of _0x2e7d55.slice()) {
      _0x38ff6c = _0x38ff6c.replace(_0x5d726a, '');
    }
  ...
  function _0x296a2f() {
    let _0x25ff43 = arguments.length > 0x0 ? arguments[0x0] : {},
        _0x1f96ad = _0x25ff43.size,
        _0x270c59 = _0x25ff43.num,
        _0xa66739 = '';
  
    for (; _0x1f96ad--;) _0xa66739 += _0x270c59[Math.random() * _0x270c59.length | 0x0];
  
    return _0xa66739;
  }
  
  function _0x4611d9(_0x200be9) {
    try {
      _0x200be9 = JSON.parse(_0x200be9);
    } catch (_0x5c27c5) {
      let _0x12dd6b = _0x1f642d([/^try.?\((\w+)\}\)*/, /^(\w+)\s*\n*\s*\(/], _0x200be9);
  
      if (_0x12dd6b) {
        let _0x25070e = _0x200be9.replace(_0x12dd6b, 'tempdata=');
  
        eval(_0x25070e), '' && (_0x200be9 = '');
      }
    }
  ...
  function _0x1f642d(_0xd52f59, _0x59f0b0) {
    _0xd52f59 = _0xd52f59 instanceof Array ? _0xd52f59 : [_0xd52f59];
  
    for (let _0x152718 of _0xd52f59) {
      let _0xb512e9 = _0x152718.exec(_0x59f0b0);
  
      if (_0xb512e9) {
        let _0x449649 = _0xb512e9.length;
        if (_0x449649 == 0x1) return _0xb512e9;else {
          if (_0x449649 == 0x2) return _0xb512e9[0x1];else {
            let _0xf0f45e = [];
  
            for (let _0x227302 = 0x1; _0x227302 < _0x449649; _0x227302++) {
              _0xf0f45e.push(_0xb512e9[_0x227302]);
            }
  ...
  (function (_0x382ac1, _0x24c946, _0x7b6445) {
    _0x7b6445 = 'al';
  
    try {
      _0x7b6445 += 'ert';
      _0x24c946 = 'jsjiami.com.v5';
    } catch (_0x11b849) {
      _0x382ac1.alert('删除版本号，js会定期弹窗');
    }
  })();
