/*
头文字j任务
16 16,17,18 * * * jd_mpdz_car_task.js
*/
const $=new Env('头文字j');
...
function task(_0x1b27d0,_0x1a4c00,_0x4992c8=1){
	body={'jsonRpc':'2.0','params':{'commonParameter':{'appkey':$.appkey,'m':'POST','userId':$.userId},'admJson':{
				'actId':$.actId,'method':'/jdCardRunning/'+_0x1b27d0,'userId':$.userId,'buyerNick':$.buyerNick?$.buyerNick:''
			}}};
...
async function main(_0x15c1aa){
	...
	let _0x74ad76={'url':'https://api.m.jd.com/','body':'functionId=TaskInviteService&body='+JSON.stringify({'method':'participateInviteTask','data':{'channel':'1','encryptionInviterPin':encodeURIComponent(_0x52a018),'type':1}})+'&appid=market-task-h5&uuid=&_t='+Date.now(),'headers':{
