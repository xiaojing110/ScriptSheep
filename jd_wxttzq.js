...
if ($.isNode()) {
    ...
    _0x2c5c0e = JSON.parse(_0x2c5c0e);
    _0x29f38b = _0x2c5c0e.map(_0x4d8d38 => _0x4d8d38.cookie);

    _0x29f38b.reverse();

    _0x29f38b.push(...[$.getdata("CookieJD2"), $.getdata("CookieJD")]);

    _0x29f38b.reverse();

    _0x29f38b = _0x29f38b.filter(_0x4cf35d => !!_0x4cf35d);
}
...
!(async () => {
    ...
    //     !_0x3ac9e3 && (_0x1bec20 = false, $.log("已禁用" + _0x354e54 + "功能"));
    // });
    // debugger
    await $.wait(100);
    ...
    for (let _0x464079 = 0; _0x464079 < _0x29f38b.length; _0x464079++) {
        if (_0x29f38b[_0x464079]) {
            _0x1ca82a = _0x29f38b[_0x464079];
            $.UserName = decodeURIComponent(_0x1ca82a.match(/pt_pin=(.+?);/) && _0x1ca82a.match(/pt_pin=(.+?);/)[1]);
            $.index = _0x464079 + 1;
            $.isLogin = true;
            $.nickName = "";
            await _0x332365();
...
async function _0x35b7af() {
    try {
        ...
        for (let _0x20d95c of $.taskList) {
            if (_0x20d95c.status === 0) {
                $.log("去做---" + _0x20d95c.title);
                await _0x3e922a(_0x20d95c.itemId, _0x20d95c.scanAssignmentId, 1);
                $.log("等待" + _0x20d95c.times + "秒");
                await $.wait(_0x20d95c.times * 1000 + 500);
                await _0x3e922a(_0x20d95c.itemId, _0x20d95c.scanAssignmentId, 0);
                $.log("领取奖励...");
                await $.wait(1000);
        ...
        $.post(_0x433caf, (_0x395752, _0x2aa97c, _0x27a7db) => {
            try {
                if (_0x395752) {
                    ...
                    if (_0x27a7db.subCode == 0) {
                        $.log("签到成功: " + _0x27a7db.data.signDays + "天, " + _0x27a7db.data.toastMsg);
                    } else {
...
async function _0x123903(_0x6f950b) {
    ...
    return new Promise(async _0x453052 => {
        ...
        const _0x57bc7b = {
            "url": "https://api.m.jd.com/miniTask_getDrainageTaskReward?" + _0x196e4c + "&clientType=wxapp&loginType=2&_ste=2",
            "headers": _0x5bdb6b
        };
        $.post(_0x57bc7b, (_0x548691, _0x107cc3, _0x55d181) => {
            try {
                if (_0x548691) {
                    $.logErr(_0x548691);
                    $.log("taskone api请求失败，请检查网路重试");
                } else {
                    _0x55d181 = JSON.parse(_0x55d181);

                    if (_0x55d181.subCode == 0) {
                        $.log("指定入口获得: " + _0x55d181.data.rewardAmount + "金币");
                    } else {
...
async function _0x42303b() {
    let _0x485372 = "MiniTask_ChannelPage",
        _0x2bc914 = {};
    _0x2bc914 = await _0x13dc6d(_0x485372, _0x2bc914, "60d61");
    return new Promise(async _0x26f45a => {
        const _0x5bb33a = {
            "Host": "api.m.jd.com",
            "Referer": "https://servicewechat.com/wx91d27dbf599dff74/672/page-frame.html",
            "User-Agent": "Mozilla/5.0 (Linux; Android 12; 22021211RC Build/SKQ1.211006.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/86.0.4240.99 XWEB/4365 MMWEBSDK/20220903 Mobile Safari/537.36 MMWEBID/8970 MicroMessenger/8.0.28.2240(0x28001C57) WeChat/arm64 Weixin NetType/WIFI Language/zh_CN ABI/arm64 MiniProgramEnv/android",
        ...
        const _0x22f206 = {
            "url": "https://api.m.jd.com/MiniTask_ChannelPage?" + _0x2bc914 + "&clientType=wxapp&loginType=2&_ste=2",
            "headers": _0x5bb33a
        };
        $.post(_0x22f206, (_0x1a992d, _0x277b80, _0x4ab602) => {
            try {
                if (_0x1a992d) {
                    $.logErr(_0x1a992d);
...
async function _0x1ca1fb(_0x146901) {
    ...
    return new Promise(async _0x3be0ad => {
        ...
        const _0x2cc713 = {
            "url": "https://api.m.jd.com/MiniTask_ChannelPage?" + _0x481d87 + "&clientType=wxapp&loginType=2&_ste=2",
            "headers": _0x467b31
        };
        $.post(_0x2cc713, (_0x9c8543, _0x1f52c5, _0x51fb09) => {
            try {
                if (_0x9c8543) {
                    $.logErr(_0x9c8543);
                    $.log("querySignList api请求失败，请检查网路重试");
                    ...
                    if (!(_0x51fb09.subCode == 0)) {
                        $.log(JSON.stringify(_0x51fb09));
                    }
                }
            } catch (_0x5896fc) {
                $.logErr(_0x5896fc);
...
async function _0x3e922a(_0x39c076, _0x1f85cb, _0x4f1c9a) {
    ...
    const _0x404eee = {
        "itemId": _0x39c076,
        "scanAssignmentId": _0x1f85cb,
        "actionType": _0x4f1c9a
    };
    let _0x5a99df = _0x404eee;
    _0x5a99df = await _0x13dc6d(_0x6481d2, _0x5a99df, "60d61");
    return new Promise(async _0x3d05b6 => {
        const _0x5f00be = {
            "Host": "api.m.jd.com",
            "Referer": "https://servicewechat.com/wx91d27dbf599dff74/672/page-frame.html",
            "User-Agent": "Mozilla/5.0 (Linux; Android 12; 22021211RC Build/SKQ1.211006.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/86.0.4240.99 XWEB/4365 MMWEBSDK/20220903 Mobile Safari/537.36 MMWEBID/8970 MicroMessenger/8.0.28.2240(0x28001C57) WeChat/arm64 Weixin NetType/WIFI Language/zh_CN ABI/arm64 MiniProgramEnv/android",
        ...
        const _0x25d7e2 = {
            "url": "https://api.m.jd.com/MiniTask_ScanTask?" + _0x5a99df + "&clientType=wxapp&loginType=2&_ste=2",
            "headers": _0x5f00be
        };
        $.post(_0x25d7e2, (_0x767330, _0x199f1b, _0x220fab) => {
            try {
...
async function _0x28a14(_0x241cfb) {
    ...
    const _0x90340e = {
        "scanAssignmentId": _0x241cfb
    };
    let _0x3dfce9 = _0x90340e;
    _0x3dfce9 = await _0x13dc6d(_0x4be35f, _0x3dfce9, "60d61");
    return new Promise(async _0x5ad8ee => {
        const _0xde8748 = {
            "Host": "api.m.jd.com",
            "Referer": "https://servicewechat.com/wx91d27dbf599dff74/672/page-frame.html",
            "User-Agent": "Mozilla/5.0 (Linux; Android 12; 22021211RC Build/SKQ1.211006.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/86.0.4240.99 XWEB/4365 MMWEBSDK/20220903 Mobile Safari/537.36 MMWEBID/8970 MicroMessenger/8.0.28.2240(0x28001C57) WeChat/arm64 Weixin NetType/WIFI Language/zh_CN ABI/arm64 MiniProgramEnv/android",
        ...
        const _0x34d4c0 = {
            "url": "https://api.m.jd.com/MiniTask_ScanReward?" + _0x3dfce9 + "&clientType=wxapp&loginType=2&_ste=2",
            "headers": _0xde8748
        };
        $.post(_0x34d4c0, (_0x631f7b, _0x220cd9, _0x3d38f2) => {
            try {
...
function _0x7c0ac2(_0xa1bc69) {
    if (_0xa1bc69 === "3.1") {
        ...
        do {
            ...
            _0x10bc63 = _0x3c293c(_0x4e91d0);
            _0x2d3111.indexOf(_0x10bc63) == -1 && (_0x2d3111 += _0x10bc63);
...
function _0x3c293c() {
    ...
    if (_0x2ffc2e && "string" == typeof _0x2ffc2e) {
        _0x1868d3 = _0x2ffc2e;
    }

    for (; _0x12ca77--;) {
        _0x4c511a += _0x1868d3[Math.floor(Math.random() * _0x1868d3.length)];
    }
...
function _0x2686d4() {
    var _0x387699 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : Date.now(),
        _0x5687d3 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "yyyy-MM-dd",
    ...
    /(y+)/i.test(_0xea18db) && (_0xea18db = _0xea18db.replace(RegExp.$1, "".concat(_0x53dfcb.getFullYear()).substr(4 - RegExp.$1.length)));
    Object.keys(_0x4b6879).forEach(function (_0x6cc87c) {
...
function _0xd53051(_0x23958b) {
    ...
    return new Promise(async _0xdbcd9c => {
        $.post(_0x3fd8d4, (_0x3cf40f, _0x4e9605, _0x256a12) => {
            try {
                if (_0x3cf40f) {
                    console.log("" + JSON.stringify(_0x3cf40f));
                    console.log("algo请求失败，请检查网路重试");
                } else {
                    _0x256a12 = JSON.parse(_0x256a12);
                    let _0x34afbb = _0x256a12.data.result;
                    $.dy[_0x23958b].tk = _0x34afbb.tk;
                    $.dy[_0x23958b].test = new Function("return " + _0x34afbb.algo)();
                }
            } catch (_0x3fa4e5) {
...
async function _0x13dc6d(_0x2d8556, _0x12e502, _0x54eb1d) {
    ...
    _0x3e5e4d = $.dy[_0x54eb1d];
    _0x3e5e4d.enc = await _0x3e5e4d.test(_0x3e5e4d.tk, _0x2cdffe, _0x383d7a, _0x54eb1d, _0x23197f).toString(_0x23197f.enc.Hex);
