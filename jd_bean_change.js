...
async function queryScores() {
	const _0x3224ab = require("./function/dylanz");
  
	let _0x179c6e = {
	  "appId": "b63ff",
	  "fn": "windControl_queryScore_v1",
	  "body": {},
	  "apid": "plus_business",
	  "user": $.UserName,
	  "code": 0,
	...
	body = await _0x3224ab.getbody(_0x179c6e);
	let _0x57c193 = {
	...
	return new Promise(_0xf47703 => {
	  $.post(_0x57c193, async (_0x21464b, _0x2aa418, _0x515b57) => {
		try {
		  const _0x6924d5 = JSON.parse(_0x515b57);
  
		  _0x6924d5.code == 1000 && ($.PlustotalScore = _0x6924d5.rs.userSynthesizeScore.totalScore);
		} catch (_0x448754) {
		  $.logErr(_0x448754, _0x2aa418);
		} finally {
		  _0xf47703();
		}
	  });
...
async function fruitinfo() {
	return new Promise(_0x5a1b69 => {
	  ...
	  $.post(_0x4e6ede, (_0x547d4a, _0x3f1477, _0x11ded0) => {
		try {
		  if (_0x547d4a) {
			!llgeterror && (console.log("\n东东农场: API查询请求失败 ‼️‼️"), console.log(JSON.stringify(_0x547d4a)));
			llgeterror = true;
		  } else llgeterror = false, safeGet(_0x11ded0) && ($.farmInfo = JSON.parse(_0x11ded0), $.farmInfo.farmUserPro && ($.JdFarmProdName = $.farmInfo.farmUserPro.name, $.JdtreeEnergy = $.farmInfo.farmUserPro.treeEnergy, $.JdtreeTotalEnergy = $.farmInfo.farmUserPro.treeTotalEnergy, $.treeState = $.farmInfo.farmUserPro.treeState));
		} catch (_0x1f9a78) {
		  $.logErr(_0x1f9a78, _0x3f1477);
		} finally {
		  _0x5a1b69();
		}
	  });
